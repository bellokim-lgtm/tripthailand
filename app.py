...
# נתוני המסלול המדויקים עם הפרדה מלאה ותאריכים נכונים
itinerary = [
    {
    ...
    {
        "stage": "תחנה 3: קאו לאק - אופציה ללינה 1",
        ...
        "activities": [
            ...
            "Mנוחה ובטן-גב על קו החוף השליו של קאו לאק."
        ]
    },
    {
        "stage": "תחנה 3: קאו לאק - אופציה ללינה 2",
    ...
    {
        "stage": "תחנה 3: קאו לאק - אופציה ללינה 3",
        ...
        "target_name": "The Little Shore Khao Lak",
    ...
    {
        "stage": "תחנה 3: קאו לאק - אופציה ללינה 4",
        ...
        "map_url": "https://maps.app.goo.gl/VTbZ3tPgFPxY6Q4T8",
        "activities": [
    ...
    {
        "stage": "תחנה 3: אטרקציית טבע בקאו לאק",
        "title": "מפלי המים של קאו לאק",
        "date_display": "📅 מהלך הטיול: 21/05 עד 28/05",
        "description": "ביקור במפלי המים המפורסמים והמרעננים של החבל. מפל סאי רונג (Sai Rung Waterfall) הוא מפל נגיש ויפהפה שנופל לבריכה טבעית, ומפל טון צ'ונג פה (Ton Chong Fa) מציע 5 מפלסים מדהימים בלב היער.",
        "target_name": "Sai Rung & Ton Chong Fa Waterfalls",
        "map_url": "https://maps.app.goo.gl/sUWjnaNtEpeG99qB7",
        "activities": [
    ...
    },
    {
        ...
        "map_url": "https://maps.app.goo.gl/xGdCf1UH5QgFwYpVA",
        "activities": [
    ...
    },
    {
        ...
        "map_url": "https://maps.app.goo.gl/cK2QAtTooaHVGyJ79",
        "activities": [
